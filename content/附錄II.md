...
為了方便你們學習，下面是我們為自動生成jlox語法樹類而[構建的小指令碼](http://www.craftinginterpreters.com/representing-code.html#metaprogramming-the-trees)所產生的程式碼。
...
你需要一個函式才能返回，所以`return`語句是在“函式”中介紹的。
